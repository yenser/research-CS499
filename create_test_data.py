...
def create_test_sets(arr1, arr2, arr3, arr4, arr5, test_size=0.1):
	features = []

	features += sample_handling(arr1, arr2, arr3, arr4, arr5)
...
def get_data_and_create_test_set(str1, str2, str3, str4, str5):
